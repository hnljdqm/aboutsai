...
public class DateUtil {
	...
	public static int compareDate(Date d1, Date d2, String format) {
		return convertDateToString(d1, format).compareTo(convertDateToString(d2, format));
	}
	...
	public static long differenceDay(Date start, Date end) {
		return differenceDay(convertDateToString(start), convertDateToString(end));
	}
	...
	public static int getYearOfLastMonth() {
		return getCurrentMonth() - 1 == 0 ? getCurrentYearInt() - 1 : getCurrentYearInt();
	}
	...
	public static int getYearOfLastQuarter() {
		return getCurrentQuarter() - 1 == 0 ? getCurrentYearInt() - 1 : getCurrentYearInt();
	}
	...
	public static Timestamp[] getBeginAndEndTimes_quarter(int addQuarters, Date date) throws Exception {
		...
		return new Timestamp[] { new Timestamp(startDate.getTime()), new Timestamp(endDate.getTime()) };
	}
